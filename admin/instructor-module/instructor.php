            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item">
                    <a href="../create_instructor.php">Create Account</a>
                  </li>
...
$result = mysqli_query($conn, "SELECT * FROM instructor_info");
?>
...
<head>
    ...
    <style>
        ...
        .center-container table {
            margin: 20px auto; /* this centers the table only */
        }
    </style>
</head>
<body>
        ...
        <table border="5" cellpadding="20" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="delete_instructor.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>
                </td>
            </tr>
            <?php } ?>
        </table>
