       ...
       <!-- Sidebar Menu -->
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="../schedule-module/schedule.php" class="nav-link active">
              ...
              <li class="nav-item">
                <a href="../program-modules/program.php" class="nav-link">
                  <i class="nav-icon fas fa-calendar-week"></i>
                  <p>PROGRAMS</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item "><a href="../scheduleposted.php">Schedule</a></li>
