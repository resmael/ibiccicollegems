        ...
        <div class="sidebar">
          ...
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item">
                <a href="../notice/notice.php" class="nav-link active">
                  <i class="nav-icon fas fa-person-chalkboard"></i>
                  <p>NOTICE</p>
                </a>
              </li>
      ...
      <div class="content-wrapper">
        ...
        <div class="card card-default">
          ...
          <div class="card-header">
              <a href="schedule.php" class="btn btn-info float-left">View Notice</a>
          ...
          <div class="card-body">
            <div class="col-12">
              <div class="form-group">
                ...
                <select class="duallistbox" multiple="multiple" name="noticeto">
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                <!-- /.form-group -->
                 <input type="submit" class="btn btn-info float-right" value="Post" name="submit">
              </div>
              <!-- /.col -->
            </div>
            <!-- /.row -->
