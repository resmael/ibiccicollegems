              ...
              <form>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="exampleInputEmail1" value="Gecko">
                  </div>
                  <div class="form-group">
                ...
                <div class="card-footer">
                  <a href="1styear.html" class="btn btn-primary">Update</a>
                  <a href="1styear.html" class="btn btn-primary">Back</a>
                </div>
              </form>
            </div>
            <!-- /.card -->
