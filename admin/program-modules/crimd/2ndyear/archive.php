        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="2ndyear.php">2nd year</a></li>
              ...
              <div class="card-body p-0">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td>Sai Marangit</td>
                    <td>
                      <a href="2ndyear.html" style="width: 98px; height: 50px;" class="btn btn-primary btn-sm">Restore</a>
                      <a href="2ndyear.html" style="width: 98px;" class="btn btn-danger btn-sm">Delete Permanently</a>
                    </td>
                  </tr>
                  <tr>
